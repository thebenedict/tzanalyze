...
terms = ["poll", "twaweza", "barare", "richmond", "CCM", "CHADEMA", "Magufuli", "Lowassa", "Slaa", "TFDA", "TCRA", "corruption", "rushwa", "obama", "usaid", "msd", "kenya", "MCC", "elephant", "tembo", "Zanzibar", "Kipindupindu" "riot" "riots"]
